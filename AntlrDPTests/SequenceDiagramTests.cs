...
public class SequenceDiagramTests
{
    ...
    [TestMethod]
    public void TestSequenceOneAltOneConditionFirstMethod()
    {
        var json = File.ReadAllText("files/OneAltOneCondition.json");
        var visitor = Setup(json);
    ...
    [TestMethod]
    public void TestSequenceOneAltOneConditionSecondMethod()
    {
        var json = File.ReadAllText("files/OneAltOneCondition.json");
        var visitor = Setup(json);
