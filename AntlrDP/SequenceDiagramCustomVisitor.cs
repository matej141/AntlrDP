...
public class SequenceDiagramCustomVisitor : SequenceDiagramBaseVisitor<object>
{
    ...
    private void AddElementToAppropriateCollection(SequenceDiagramElement element)
    {
        switch (element)
        {
            ...
            case Message message:
                ...
                break;
            case OccurenceSpecification occurenceSpecification:
    ...
    private static OccurenceSpecification CreateOccurenceSpecification(
        SequenceDiagramParser.PairContext[] pairContexts)
    {
        ...
        return new OccurenceSpecification { XmiId = id, ReferenceIdOfCoveredObject = coveredByContext };
    }
