...
{
    [TestMethod]
    public void Test_Sqd_HelloMessage_Lifelines()
    {
    ...
    [TestMethod]
    public void Test_Sqd_HelloMessage_CountOfMessages()
    {
        var json = File.ReadAllText("files/HelloMessage.json");
        var visitor = Setup(json);
    ...
    [TestMethod]
    public void Test_Sqd_HelloMessageOccurrence_Specifications()
    {
        var json = File.ReadAllText("files/HelloMessage.json");
        var visitor = Setup(json);
    ...
    [TestMethod]
    public void Test_Sqd_OneOpt_CombinedFragment()
    {
    ...
    [TestMethod]
    public void Test_Sqd_OneOpt_InteractionOperand()
    {
        var json = File.ReadAllText("files/OneOpt.json");
        var visitor = Setup(json);
    ...
    [TestMethod]
    public void Test_Sqd_OneOpt_InteractionConstraint()
    {
        var json = File.ReadAllText("files/OneOpt.json");
        var visitor = Setup(json);
    ...
    [TestMethod]
    public void Test_Sqd_OneOpt_OpaqueExpression()
    {
        var json = File.ReadAllText("files/OneOpt.json");
        var visitor = Setup(json);
